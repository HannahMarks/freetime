...
// without wrapping every test in <SafeAreaProvider>. Wraps in a real View
// so that style/testID/onLayout/etc. props are preserved (callers do put
// testIDs and styles on SafeAreaView).
